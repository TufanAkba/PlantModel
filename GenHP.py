...
class Complex2(pyc.Cycle):
    ...
    def setup(self):
        ...
        self.connect('LPcomp.trq', 'HPshaft.trq_0')
        self.connect('HPturb.trq', 'HPshaft.trq_1')
        
        self.connect('HPcomp.trq', 'LPshaft.trq_0')
        ...
        if design:
            ...
            balance.add_balance('HP_Nmech', lower=20000., upper=35000., units='rpm', eq_units='hp', rhs_val=0.)
...
class MPComplex2(pyc.MPCycle):
    ...
    def setup(self):
        ...
        # self.od_pwrs = [0.,-50.,175., 100.]
        # self.Q_Solar = [700.,600.,1050., 750.]
        # setting_mode = ['nozzle','nozzle','T4', 'nozzle']
        
        # self.od_pts = ['Max_105', 'Min_75','SelfSupplied','Motoring']
        # self.od_pwrs = [180., 100., 0.,-50.]
        # self.Q_Solar = [1050., 750., 700.,600.]
        # setting_mode = ['T4','T4','T4', 'T4']
        
        # self.od_pts = ['Min_75', 'Max_105']
        # self.od_pwrs = [ 100., 175.]
        # self.Q_Solar = [750., 1050.]
        # setting_mode = ['nozzle', 'T4']
        
        
        # self.od_pts = ['Min50','Min0','Min10']
        # self.od_pwrs = [0.,0.,0.]
        # self.Q_Solar = [1000.,975.,950.]
        # setting_mode = ['nozzle','nozzle','nozzle']
        
        self.od_pts = ['Max210','Max200','Max190','Max180','Od170','Min160','Min150','Min140','Min130','Min120','Min110','Min100']
        self.od_pwrs = [210.,200.,190.,180.,170.,160.,150.,140.,130.,120.,110.,100]
        self.Q_Solar = [1080.,1060.,1040.,1010.,990.,960.,940.,910.,890.,860.,840.,810.]
        setting_mode = ['T4','T4','T4','T4','T4','T4','T4','T4','T4','T4','T4','T4']
