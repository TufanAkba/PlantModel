...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 11 01:09:28 2022

@author: tufanakba
Cascaded system test
--- Actual model will be implemented and no surrogate used
+++ surrogate used and works
"""

import openmdao.api as om
from viewer2 import viewer, viewer2, map_plots, sankey
# from receiver import ReceiverSubProblem
from MPComplex2 import MPComplex2
...
if __name__ == "__main__":
    ...
    # L = 0.07284691583945686 m
    # INS = 0.0974996566047779 m 
    # RPC = 0.009872150568000776 m
    # mass_flow = 0.0008400253137549042 kg/s
    
    # optimized vals
    L = 0.07284691583945686
    s_INS = 0.0974996566047779
    s_RPC = 0.009872150568000776
    ...
    prob['DESIGN.balance.LPturb_PR'] = 3.2
    prob['DESIGN.balance.HPturb_PR'] = 1.6
    ...
    #     # initial guesses
    #     prob['DESIGN.balance.W'] = 0.00183
    #     prob['DESIGN.balance.LPturb_PR'] = 3.2
    #     prob['DESIGN.balance.HPturb_PR'] = 2.
    #     # prob['DESIGN.balance.comp_PR'] = 4.489
    #     prob['DESIGN.fc.balance.Pt'] = 14.696
    #     prob['DESIGN.fc.balance.Tt'] = 518.670 #518.665288153
    ...
    #         prob[pt+'.fc.balance.Pt'] = 14.696
    #         prob[pt+'.fc.balance.Tt'] = 518.670                         
    #         prob[pt+'.HPturb.PR'] = 3.9#3,2.9,3.5,3
    #         prob[pt+'.LPturb.PR'] = 2.#1.4,1,1.6,2.9Oğlum
    #         prob[pt+'.LPcomp.PR'] = 2.#1.8,1.7,0.8,2.1
    #         prob[pt+'.HPcomp.PR'] = 2.6#4.5,4.2,3.5,5
    #         prob[pt+'.LPcomp.map.RlineMap'] = 2.0
    #         prob[pt+'.HPcomp.map.RlineMap'] = 2.0
