...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 17 17:26:27 2022

@author: tufanakba

for multi point map plot
"""
#import sys
import numpy as np
...
def comp_map_all(prob):
    ...
    for e_id, e_name in enumerate(element_names):
        ...
        for alpha in alphas:
            ...
            plt.clabel(Nc, fontsize=12, inline=False)
            plt.clabel(R, fontsize=12, inline=False)
